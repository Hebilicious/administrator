<div class="table_container">
	...
	<div class="results_header">
		...
		<div class="actions">
			...
			<input id="filter-btn-success" type="button" value="<?php echo trans('administrator::administrator.filters') ?>" class="btn btn-w-m btn-success" />
	...
	'sorted-desc': (column_name == $root.sortOptions.field() || sort_field == $root.sortOptions.field()) && $root.sortOptions.direction() === 'desc'}">
		...
		<tbody>
			<!-- ko foreach: rows -->
				<tr data-bind="click: function() {$root.clickItem($data[$root.primaryKey].raw); return true},css: {result: true, even: $index() % 2 == 1, odd: $index() % 2 != 1,
